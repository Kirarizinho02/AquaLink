  ...
  return (
    <div className="grid gap-4">
        ...
        >
          ...
          <div className="relative z-10">
            ...
            <div className="flex flex-col items-start mb-6">
              ...
              <span className="text-xs text-white/80">no período selecionado</span>
            </div>
            {/* Filtros */}
        ...
        <div className="bg-absolute-white dark:bg-black dark:border-white/40 border-black/20 border rounded-xl flex flex-col p-4 min-h-[140px]">
          <div className="flex items-center mb-2">
            <span
              ...
              style={{ width: 32, height: 32 }}
            >
              <Bell className="text-azul-primario dark:text-azul-quintenario" size={18} />
            </span>
          ...
          {reminders.length === 0 ? (
            <div className="flex-1 grid place-items-center">
              <span className="text-gray-500">Nenhum lembrete cadastrado</span>
            </div>
          ) : (
            (() => {
              const now = new Date();
              ...
              const remindersWithTime = reminders
                .filter((r: any) => r?.horario && /^\d{2}:\d{2}$/.test(r.horario))
                .map((r: any) => {
              ...
              let next = remindersWithTime.find((r: any) => r.minutes > currentMinutes);
              if (!next && remindersWithTime.length > 0) next = remindersWithTime[0];

              const others = remindersWithTime.filter((r: any) => r !== next);
                ...
                <div className="flex-1 flex flex-col">
                  ...
                  <div className="flex-1 grid place-items-center">
                    <div className="text-start w-full">
                      ...
                      <span className="ml-2 text-2xl">{next ? next.horario : "--:--"}</span>
                    </div>
                  </div>
                  {/* Fundo: outros lembretes e botão */}
                  {others.length > 0 && (
                    <div className="pt-2 flex flex-col gap-2">
                      <span className="text-xs text-gray-600 dark:text-gray-400">Outros lembretes:</span>
                        ...
                        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40">
                          <div className="bg-white dark:bg-gray-900 rounded-xl p-6 shadow-lg min-w-[300px]">
                            <div className="flex justify-between items-center mb-4">
                              <h2 className="text-lg font-bold">Adicionar Lembrete</h2>
                              <button
                            ...
                            <form
                              onSubmit={(e) => {
                                ...
                                if (horario) {
                                  ...
                                  import("firebase/database").then(({ push }) => {
                            ...
                            >
                              <label className="block mb-2 text-sm font-medium">
                                Horário
                                <input type="time" name="horario" required className="block w-full mt-1 rounded border px-2 py-1" />
                              </label>
                              <div className="flex justify-end mt-4">
                                ...
                                <button type="submit" className="px-3 py-1 rounded bg-green-500 text-white font-semibold hover:bg-green-600">
                                  Salvar
                                </button>
                              </div>
                            </form>
      ...
      <div className="grid md:grid-cols-1 lg:grid-cols-2 gap-4">
        ...
        <div className="bg-absolute-white dark:bg-black dark:border-white/40 border-black/20 border rounded-xl p-4 flex flex-col">
          <div className="flex items-center mb-4">
            <span
              ...
              style={{ width: 32, height: 32 }}
            >
              <ChartArea className="text-azul-primario dark:text-azul-quintenario" size={18} />
            </span>
          ...
          <ResponsiveContainer width="100%" height={340}>
            <BarChart data={chartData}>
              {period === 30 ? <XAxis dataKey="semana" /> : <XAxis dataKey="dia" />}
        ...
        {/* Coluna direita: Sua Garrafa + Últimas Leituras */}
        <div className="grid gap-4">
          {/* Sua Garrafa */}
          <div className="bg-absolute-white dark:bg-black dark:border-white/40 border-black/20 border rounded-xl flex flex-col p-4">
            <div className="flex items-center mb-2 ">
              <span
                ...
                style={{ width: 32, height: 32 }}
              >
                <GlassWater className="text-azul-primario dark:text-azul-quintenario" size={18} />
              </span>
              <span className="ml-3 text-lg font-semibold text-azul-primario font-poppins dark:text-azul-quintenario">
                Sua Garrafa
              </span>
              ...
              <div className="flex flex-col items-center w-1/2 border-e-2">
                {bottleInfo ? (
                  <div className="flex flex-col items-center">
                    ...
                    <img src={aqualink_classic} alt="Garrafa" className="max-h-full my-2" />
                  ...
                  <div className="flex flex-col items-center my-auto">
                    ...
                    <span className="text-xs text-gray-500">Cadastrada em --/--/----</span>
                  </div>
                )}
              </div>
              {/* Direita */}
          ...
          <div className="bg-absolute-white dark:bg-black dark:border-white/40 border-black/20 border rounded-xl p-4">
            <div className="flex items-center mb-2 ">
              <span
                ...
                style={{ width: 32, height: 32 }}
              >
                <Paperclip className="text-azul-primario dark:text-azul-quintenario" size={18} />
              </span>
              <span className="ml-3 text-lg font-semibold text-azul-primario font-poppins dark:text-azul-quintenario">
                Últimas Leituras
              </span>
            </div>
            <div className="space-y-2 cursor-pointer" onClick={() => setIsDialogOpen(true)}>
              {[...hydrationData]
                .reverse()
                .slice(0, 4)
                .map((reading, index) => (
                  <div key={index} className="flex justify-between border-b py-2 last:border-none text-gray-700 dark:text-gray-300">
              ...
              <DialogContent>
                ...
                <div className="space-y-2">
                  {paginatedData.map((reading, index) => (
                    <div key={index} className="flex justify-between border-b py-2 last:border-none">
